...
- Use `specspine consistency scan . --json` to export local spec-code-test-doc drift evidence only. Do not treat consistency scan recommended commands as executed commands.
...
- Use `specspine retrospective report . --json` to export local retrospective evidence only. Do not treat retrospective recommended commands as executed commands.
...
- Use `specspine verify matrix <slug> . --json` to export local AC-level verification evidence only. Do not treat verification matrix recommended commands as executed commands or proof that tests ran.
- Use `specspine provenance manifest . --json` to export local file hashes and feature evidence only. Do not treat provenance recommended commands as executed commands or as proof that tests ran.
