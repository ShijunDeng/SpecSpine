    ...
    def test_create_feature_bundle_in_plain_workspace(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            for command in (
                ...
                "specspine consistency scan . --feature add-dark-mode --json",
                ...
                "specspine provenance manifest . --feature add-dark-mode --json",
            ...
            self.assertIn("specspine consistency scan . --feature add-dark-mode --json", quality)
            self.assertIn("specspine hygiene scan . --json", quality)
            self.assertIn("specspine retrospective report . --json", quality)
            self.assertIn("specspine verify matrix add-dark-mode . --json", quality)
            ...
            self.assertIn("specspine provenance manifest . --feature add-dark-mode --json", quality)
