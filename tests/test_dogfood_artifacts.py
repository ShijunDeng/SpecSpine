...
class DogfoodArtifactsTests(TestCase):
    ...
    def test_feature_task_export_dogfood_bundle_passes_default_and_coverage_gates(self) -> None:
        default_report = build_feature_ready_report(REPO_ROOT, "feature-task-export")
        coverage_report = build_feature_ready_report(
            REPO_ROOT,
            "feature-task-export",
            require_coverage=True,
    ...
    def test_feature_traceability_export_dogfood_bundle_passes_default_and_coverage_gates(self) -> None:
    ...
    def test_status_validation_summary_dogfood_bundle_passes_default_and_coverage_gates(self) -> None:
        default_report = build_feature_ready_report(REPO_ROOT, "status-validation-summary")
        coverage_report = build_feature_ready_report(
            REPO_ROOT,
            "status-validation-summary",
            require_coverage=True,
    ...
    def test_feature_test_coverage_links_dogfood_bundle_passes_default_and_coverage_gates(self) -> None:
        default_report = build_feature_ready_report(REPO_ROOT, "feature-test-coverage-links")
        coverage_report = build_feature_ready_report(
            REPO_ROOT,
            "feature-test-coverage-links",
            require_coverage=True,
    ...
    def test_quality_gate_definitions_dogfood_bundle_passes_default_and_coverage_gates(self) -> None:
        default_report = build_feature_ready_report(REPO_ROOT, "quality-gate-definitions")
        coverage_report = build_feature_ready_report(
            REPO_ROOT,
            "quality-gate-definitions",
            require_coverage=True,
    ...
    def test_feature_test_coverage_links_dogfood_exports_coverage(self) -> None:
        ...
        self.assertEqual(report.summary["test_coverage"], {"done": 11, "open": 0, "total": 11})
