...
- Keep generated feature templates focused on the current handoff/task-issues/tests/pr/ready workflow so agents start with local commands and unchecked gates instead of generic placeholders.
