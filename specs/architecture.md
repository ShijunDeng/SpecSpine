...
- `features` creates and reads native feature bundles, updates lifecycle status, exports execution task handoffs, exports traceability handoffs, evaluates readiness gates, and exports offline issue drafts.
...
- The main machine interfaces are `specspine status . --json`, `specspine status . --json --validate`, `specspine feature trace <slug> . --json`, `specspine feature ready <slug> . --json`, and `specspine validate . --fusion --features`.
